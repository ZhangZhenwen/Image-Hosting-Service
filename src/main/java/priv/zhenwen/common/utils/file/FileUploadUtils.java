package priv.zhenwen.common.utils.file;

import org.apache.commons.io.FilenameUtils;
import org.springframework.web.multipart.MultipartFile;
import priv.zhenwen.common.constant.Constants;
import priv.zhenwen.common.utils.DateUtils;
import priv.zhenwen.common.utils.StringUtils;
import priv.zhenwen.common.utils.exception.file.FileNameLengthLimitExceededException;
import priv.zhenwen.common.utils.exception.file.FileSizeLimitExceededException;
import priv.zhenwen.common.utils.exception.file.InvalidExtensionException;
import priv.zhenwen.config.ApplicationConfig;
...
public class FileUploadUtils {
     ...
     * 编码文件名
     */
    private static String encodingFilename()
    {
     ...
     * @param file 上传的文件
     * @throws FileSizeLimitExceededException 如果超出最大大小
     * @throws InvalidExtensionException 文件后缀错误
     */
     ...
     *
     * @param extension 后缀名
     * @param allowedExtension 被允许的后缀名
     * @return 后缀名是否被允许
     */
